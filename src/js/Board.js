...
export default class Board {
  ...
  drawBoard() {
    ...
    <h2 class="column__header">Список задач</h2>
    <ul class="tasks-list todo"></ul>
    <div class="column__add">+ Добавить задачу</div>
  </div>
  <div class="column">
    <h2 class="column__header">В выполнении</h2>
    <ul class="tasks-list in-progress" id="trew"></ul> 
    <div class="column__add">+ Добавить задачу</div>
  </div>
  <div class="column">
    <h2 class="column__header">Вполнено</h2>
  ...
  addInput(event) {
    ...
    <textarea class="add-form__textarea" type ="text" placeholder="Введите текст задачи"></textarea>
    <div class="add-form__form-control">
      <button class="add-form__submit-button add-form__button">Добавить</button>
      <button class="add-form__close-button add-form__button">Закрыть</button>
    </div>
 `;
  ...
  closeForm(event) {
    ...
    columnAdd.textContent = "+ Добавить задачу";
